...
public class CursomcApplication implements CommandLineRunner {
	...
	public void run(String... args) throws Exception {
		...
		Cidade  c1 = new Cidade(null,"Ubelãndia",est1);
		...
		Pedido ped1 = new Pedido(null, sdf.parse("16/05/2018 17:06"), cli1, e1);
		Pedido ped2 = new Pedido(null, sdf.parse("06/05/2018 09:023"), cli1, e2);
